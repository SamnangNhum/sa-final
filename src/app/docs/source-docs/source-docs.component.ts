...
@Component({
  ...
  templateUrl: './source-docs.component.html',
  styleUrls: ['./source-docs.component.less'],
})
export class SourceDocsComponent implements OnInit {
